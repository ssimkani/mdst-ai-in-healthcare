...
This is a demo of the project, 'Building Interpretable AI in Healthcare'. The demo analyzes data from a synthetic dataset of Alzheimer's patients. A simple Random Forest model is used to predict if an individual has Alzheimer's given a set of cognitive diagnostics/assessments.

-----------------------------------------------------------------------------------------------

## [Website Link](https://mdst-ai-in-healthcare.streamlit.app/) (Hosted on Streamlit)
...
## Model Interpretability and Uncertainty Emphasis
...
- Machine Learning (exploring different models)
...
- Using MAPIE for uncertainty quantification (conformal predictions)
- Calibratiing probabilities
- Controlling Risk
- SHAP for model interpretability
- SHAP visualizations

#### Libraries used for Part 3
...
- Streamlit and Web Development
- Creating visualizations on Streamlit
- Deploying predictive model with complete transparency

#### Libraries used for Part 4
